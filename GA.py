...
files.upload()   # Upload cinema_hall_ticket_sales.csv
...
df = pd.read_csv("cinema_hall_ticket_sales.csv", encoding="latin1")

print("Dataset berjaya dibaca ✅")
print(df.head())
...
# ======================================
# 🔴 JIKA NAMA COLUMN BERBEZA, TUKAR DI SINI
